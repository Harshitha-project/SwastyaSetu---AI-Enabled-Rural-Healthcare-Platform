...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'SwasthyaSetu - Healthcare Beyond Distance',
        short_name: 'SwasthyaSetu',
        description: 'Rural healthcare platform connecting patients with doctors through teleconsultation',
        theme_color: '#0d9488',
        ...
        shortcuts: [
          {
            ...
            icons: [{ src: '/icons/assessment-96x96.png', sizes: '96x96' }],
          },
          {
            ...
            icons: [{ src: '/icons/appointment-96x96.png', sizes: '96x96' }],
          },
          {
            name: 'Emergency',
            ...
            url: '/emergency',
            icons: [{ src: '/icons/emergency-96x96.png', sizes: '96x96' }],
          },
        ],
      },
      workbox: {
